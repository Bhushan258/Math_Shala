...
QueGen=(questions)=>{
    ...
    var y = getRandomInt(10,99);
    var z = parseInt(y / x);
    var t= y%x;
    var choices=[];
    c=getRandomfromList([z,t]);
    choices[0]=c;
    if(choices[0]==z){
        var Que="What is Quotient, if "+y+" divide by "+x+"  ? (Remainder = "+t+" )";
    }else{
        var Que="What is Remainder, if "+y+" divide by "+x+"  ? (Quotient = "+z+")";
    }
    for (let i=1; i<=3; i++){
